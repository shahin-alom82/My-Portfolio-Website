                  ...
                  <footer className="mt-20 bg-opacity-5 bg-purple-600 rounded-full">
                        <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                              <div className="sm:flex sm:items-center sm:justify-between">
                                    <div>
                                          <span className="self-center text-4xl font-semibold whitespace-nowrap uppercase text-purple-600 lg:text-start lg:ml-0 ml-10">Sha<span className='text-purple-700'>hin</span> Alom</span>
                                          <h1 className='text-xl mt-3 lg:ml-0 ml-10'>Web Developer & Designer</h1>
                                    </div>


                                    <ul className="items-center mb-6 text-lg font-medium lg:ml-0 ml-10">
                                          <h1>Contact ME :-</h1>
                              ...
                              <span className="block lg:text-xl text-sm  sm:text-center lg:ml-0 ml-10" >© 2024 <a href="#">Your Name™</a>. All Rights Reserved.</span>
