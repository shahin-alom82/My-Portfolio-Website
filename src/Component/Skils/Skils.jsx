      ...
      return (
            <div className="mx-[55px] lg:ml-[80px]">
                  ...
                  <div className="grid lg:grid-cols-5 grid-cols-2 space-y-12 gap-4 lg:ml-8 mt-10">
                        ...
                        <article className="border-white lg:w-48 lg:h-40 rounded-xl mt-12 relative max-w-xs overflow-hidden bg-cover bg-no-repeat hover:rotate-[8deg] duration-500 cursor-pointer">
                              ...
                              <div className=" bg-[#140c1c] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2  lg:w-48 lg:h-40 shadow dark:bg-gray-800 ">
                                    ...
                                    <div className="">
                                          <a href="#">
                                                <h2 className="lg:text-[20px] mt-3 font-bold">90%</h2>
                                                <h5 className="lg:text-[18px] text-center tracking-tight text-white mt-2 font-semibold">HTML 5</h5>
                                          </a>
                                    </div>
                              </div>


                              <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-[#7041cf] duration-500 bg-fixed opacity-0 transition ease-in-out hover:opacity-60">
                              </div>
                        ...
                        <article className="border-white lg:w-48 lg:h-40 rounded-xl relative max-w-xs overflow-hidden bg-cover bg-no-repeat hover:rotate-[8deg] duration-500 cursor-pointer">
                              ...
                              <div className=" bg-[#140c1c] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 lg:w-48 lg:h-40 shadow dark:bg-gray-800 ">
                                    ...
                                    <div className="">
                                          <a href="#">
                                                <h2 className="lg:text-[20px] mt-2 font-bold">90%</h2>
                                                <h5 className="lg:text-[18px] text-center tracking-tight text-white mt-2 font-semibold">CSS</h5>
                                          </a>
                                    </div>
                              </div>
                        ...
                        <article className="border-white lg:w-48 lg:h-40 rounded-xl relative max-w-xs overflow-hidden bg-cover bg-no-repeat hover:rotate-[8deg] duration-500 cursor-pointer">
                              ...
                              <div className=" bg-[#140c1c] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 lg:w-48 lg:h-40 shadow dark:bg-gray-800 ">
                                    ...
                                    <div className="">
                                          <a href="#">
                                                <h2 className="lg:text-[20px] mt-3 font-bold">90%</h2>
                                                <h5 className="lg:text-[18px] text-center tracking-tight text-white mt-3 font-semibold">Java Script</h5>
                                          </a>
                                    </div>
                              </div>
                        ...
                        <article className="border-white lg:w-48 lg:h-40 rounded-xl relative max-w-xs overflow-hidden bg-cover bg-no-repeat hover:rotate-[8deg] duration-500 cursor-pointer">
                              ...
                              <div className=" bg-[#140c1c] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2  lg:w-48 lg:h-40 shadow dark:bg-gray-800 ">
                                    ...
                                    <div className="">
                                          <a href="#">
                                                <h2 className="lg:text-[20px] mt-2 font-bold">85%</h2>
                                                <h5 className="lg:text-[18px] text-center tracking-tight text-white mt-1 font-semibold">React js</h5>
                                          </a>
                                    </div>
                              </div>
                              ...
                              <div className=" bg-[#140c1c] font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2  lg:w-48 lg:h-40 shadow dark:bg-gray-800 ">
                                    ...
                                    <div className="">
                                          <a href="#">
                                                ...
                                                <h5 className="lg:text-[18px] text-center tracking-tight text-white mt-2 font-semibold">Node js</h5>
                                          </a>
                                    </div>
                              </div>
