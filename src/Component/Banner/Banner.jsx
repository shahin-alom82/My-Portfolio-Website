      ...
      return (
            <div>
                  <div className="flex flex-col lg:flex-row text-white">
                        {/* text serction */}
                        <div className=" text-white mt-56 px-6 sm:py-10 sm:px-8 md:py-12 md:px-16 lg:px-20 xl:py-16 xl:px-24">
                        ...
                        {/* Image Section */}
                        <div className="lg:ml-40 ml-[35px] mt-60  w-[330px] h-[400px]  border-4 rounded-3xl border-purple-700 cursor-pointer">
