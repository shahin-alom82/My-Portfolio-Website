...
const Banner = () => {
      ...
      const stringValue = ["I build Things for wait", "Fontent Developer"]
            ...
            <Container id={"about"}>
                  <div>
                        <div className="flex flex-col lg:flex-row text-white">
                              {/* text serction */}
                              <div className=" text-white mt-[70px] px-6 sm:py-10 sm:px-8 md:py-12 md:px-16 lg:px-20 xl:py-16 xl:px-24">
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-3xl font-semibold duration-500 lg:text-start text-center">Hi, My Name is</h1>
